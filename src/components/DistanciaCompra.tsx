  ...
  return (
    <div className="pt-10">
      ...
      <div className="text-xl">
        Quieres comprar tu Ticket digital presiona comprar ahora prueba prueba
      
      </div>
      <div className="grid sm:grid-cols-4 grid-cols-2 sm:gap-5 gap-3 pt-10 pb-10">
        <div id="Comprar" className="bannerPrecio bg-cover bg-center cursor-pointer" data-aos="flip-left" data-aos-duration="1000" onClick={() => window.location.href = '/compra'}>
